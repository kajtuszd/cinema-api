...
type User struct {
	...
	Username    string `json:"username" gorm:"not null" validate:"unique_username"`
	...
	Email       string `json:"email" gorm:"not null;email" validate:"unique_email"`
	PhoneNumber string `json:"phone" gorm:"type:varchar(20);unique" validate:"unique_phone"`
